export default {
  ...
  booking: {
    ...
    availableTimes: 'Uhrzeit',
    slotMode: 'Zeitslots',
    manualMode: 'Manuell',
    manualTimeHint: 'Beliebige Startzeit eingeben.',
  ...
  admin: {
    ...
    appointmentMode: 'Termin',
    blockTimeMode: 'Zeit blockieren',
    blockTimeTitle: 'Zeit blockieren',
    startTime: 'Start',
    endTime: 'Ende',
    blockLabel: 'Bezeichnung (optional)',
    blockLabelPlaceholder: 'z.B. Pause, Abwesend, Mittagspause',
  ...
  toast: {
    ...
    blockTimeSuccess: 'Zeit erfolgreich blockiert.',
    blockTimeRequired: 'Bitte Start- und Endzeit auswählen.',
    ...
    appointmentTimeUpdated: 'Terminzeit erfolgreich aktualisiert',
    appointmentDateAndTimeUpdated: 'Termindatum und -zeit erfolgreich aktualisiert',
    appointmentCancelled: 'Termin erfolgreich storniert. Kunde wurde benachrichtigt.',
    dateMarkedAsOff: 'Datum als Ruhetag markiert',
    offDateRemoved: 'Ruhetag entfernt',
    dateNotAvailable: 'Dieses Datum ist nicht für Buchungen verfügbar (Ruhetag)',
    serviceDeleted: 'Dienstleistung erfolgreich gelöscht',
    serviceActivated: 'Dienstleistung "{name}" aktiviert',
    serviceDeactivated: 'Dienstleistung "{name}" deaktiviert',
    confirmDeleteService: 'Möchten Sie diese Dienstleistung wirklich löschen?',
    confirmDeleteTimeSlot: 'Möchten Sie diesen Zeitslot wirklich löschen?'
  }
}
